...
class UpdateCachedFavouriteCoinsUseCaseTest {
    ...
    @Test
    fun `When remote favourite coins has error result should return error and not update cache`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `When remote favourite coins has success result should update cache and return success`() =
        runTest {
            // Arrange
            val coinIds = listOf(FavouriteCoinId("Qwsogvtv82FCd"))
            val rawCoinIds = listOf("Qwsogvtv82FCd")
